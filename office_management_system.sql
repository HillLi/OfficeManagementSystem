...
CREATE TABLE `oa_approval_history`  (
  ...
  `biz_type` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `biz_id` bigint(0) NOT NULL,
  `operator_id` bigint(0) NOT NULL,
  `action` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `opinion` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `oa_document`  (
  `id` bigint(0) NOT NULL,
  `doc_no` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `doc_type` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `urgency` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT '普通',
  `secrecy_level` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT '公开',
  `knowledge_scope` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  ...
  `distribution_status` varchar(30) CHARACTER SET utf8mb4 NULL DEFAULT 'not_distributed',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 ROW_FORMAT = Dynamic;
...
CREATE TABLE `oa_flow_instance`  (
  ...
  `biz_type` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `biz_id` bigint(0) NOT NULL,
  `current_node_key` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `status` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `oa_flow_task`  (
  ...
  `biz_type` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `biz_id` bigint(0) NOT NULL,
  `node_key` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `approver_role` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `oa_meeting`  (
  ...
  `venue_type` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `meeting_type` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `budget` decimal(10, 2) NULL DEFAULT NULL,
  `risk_report_url` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `security_plan_url` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `emergency_plan_url` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  ...
  `minutes` longtext CHARACTER SET utf8mb4 NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 ROW_FORMAT = Dynamic;
...
CREATE TABLE `oa_meeting_fee_standard`  (
  ...
  `meeting_type` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb4 ROW_FORMAT = Dynamic;
...
CREATE TABLE `oa_meeting_room`  (
  ...
  `equipment` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `location` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `oa_report`  (
  ...
  `secrecy_level` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `applicant_id` bigint(0) NOT NULL,
  `dept_id` bigint(0) NOT NULL,
  `content` longtext CHARACTER SET utf8mb4 NULL,
...
CREATE TABLE `oa_seal`  (
  `id` bigint(0) NOT NULL,
  `seal_name` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  `seal_type` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `dept_id` bigint(0) NOT NULL,
...
CREATE TABLE `oa_seal_log`  (
  ...
  `applicant_id` bigint(0) NOT NULL,
  `purpose` varchar(500) CHARACTER SET utf8mb4 NOT NULL,
  `material_url` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `copies` int(0) NULL DEFAULT 1,
  `take_out` tinyint(0) NULL DEFAULT 0,
  `matter_level` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `use_time` datetime(0) NULL DEFAULT NULL,
  `return_time` datetime(0) NULL DEFAULT NULL,
  `status` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `take_out_reason` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `take_out_location` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `oa_seal_transfer`  (
  ...
  `material_url` varchar(500) CHARACTER SET utf8mb4 NOT NULL,
  `remark` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `oa_travel`  (
  ...
  `staff_level` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `travel_type` varchar(30) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `transport` varchar(50) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `budget` decimal(10, 2) NULL DEFAULT NULL,
  `actual_expense` decimal(10, 2) NULL DEFAULT NULL,
  `status` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `receipt_url` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `over_limit_reason` varchar(1000) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `oa_travel_standard`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `staff_level` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `travel_type` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  `city_level` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `sys_attachment`  (
  ...
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `original_name` varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `storage_path` varchar(1000) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `file_size` bigint(0) NULL DEFAULT NULL,
  `content_type` varchar(120) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `deleted` tinyint(0) NULL DEFAULT 0,
  `deleted_by` bigint(0) NULL DEFAULT NULL,
  `deleted_at` datetime(0) NULL DEFAULT NULL,
  `delete_reason` varchar(500) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_dept`  (
  `id` bigint(0) NOT NULL,
  `dept_name` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `sys_dict_item`  (
  `id` bigint(0) NOT NULL,
  `dict_type` varchar(60) CHARACTER SET utf8mb4 NOT NULL,
  `dict_code` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  `dict_label` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `sys_notification`  (
  ...
  `receiver_id` bigint(0) NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `content` varchar(1000) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `read_status` tinyint(0) NULL DEFAULT 0,
  `biz_type` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `sys_operation_log`  (
  ...
  `biz_type` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `biz_id` bigint(0) NULL DEFAULT NULL,
  `detail` varchar(1000) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_role`  (
  ...
  `role_key` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `sys_user`  (
  ...
  `real_name` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `dept_id` bigint(0) NOT NULL,
  `email` varchar(100) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `status` tinyint(0) NULL DEFAULT 1,
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `updated_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
