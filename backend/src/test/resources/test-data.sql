MERGE INTO sys_dict_type (id, dict_type, dict_name, system_type, enabled) KEY(id) VALUES
...
MERGE INTO sys_dict_item
  (id, dict_type, dict_code, dict_label, sort_order, enabled, system_item) KEY(id) VALUES
...
MERGE INTO sys_dept (id, dept_name, parent_id) KEY(id) VALUES
(1, '党委办公室校长办公室', 0),
(2, '财务部', 0),
(3, '保卫部', 0),
(4, '信息科学技术学院', 0);

MERGE INTO sys_role (id, role_name, role_key, level, description) KEY(id) VALUES
...
MERGE INTO sys_user (id, username, password, real_name, dept_id, email) KEY(id) VALUES
...
MERGE INTO oa_seal (id, seal_name, seal_type, dept_id, keeper_id, status) KEY(id) VALUES
(1, '北京大学行政印章', '行政印章', 1, 8, 'in_store'),
(2, '信息科学技术学院公章', '部门印章', 4, 8, 'in_store');

MERGE INTO oa_meeting_room (id, room_name, capacity, equipment, location, status) KEY(id) VALUES
